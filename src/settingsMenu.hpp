...
namespace doh {
  ...
  struct settingsMenu : WITE::db_singleton {
    static constexpr uint64_t typeId = 10001004;
    static constexpr std::string dbFileId = "settingsMenu";
